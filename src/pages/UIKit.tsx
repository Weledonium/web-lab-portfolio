  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 p-8 space-y-12">
      ...
      <section className="space-y-4 max-w-md">
        ...
        <Input id="ui-help" type="email" label="Help Text" helpText="E-posta adresinizi girin" />
      ...
      <section className="space-y-4 max-w-xl">
        ...
        <Alert variant="error" title="Hata" dismissible onDismiss={() => console.log('kapatıldı')}>Bir hata oluştu.</Alert>
      </section>
    </div>
  );
}